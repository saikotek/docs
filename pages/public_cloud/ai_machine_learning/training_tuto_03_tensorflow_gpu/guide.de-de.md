...
If you want to launch it from the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de), just follow this [guide](/pages/public_cloud/ai_machine_learning/training_guide_06_howto_notebooks) and select the `Tensorflow 2` docker image.
