...
Their official pricing is available in the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl) or on the [OVHcloud Public Cloud website](https://www.ovhcloud.com/pl/public-cloud/prices/).
...
The sizing depends on the selected amount of compute resources, check the details on the [OVHcloud Public Cloud website](https://www.ovhcloud.com/pl/public-cloud/prices/).
