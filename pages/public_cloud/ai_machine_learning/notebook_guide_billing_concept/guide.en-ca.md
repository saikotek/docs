...
Their official pricing is available in the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca) or on the [OVHcloud Public Cloud website](https://www.ovhcloud.com/en-ca/public-cloud/prices/).
...
The sizing depends on the selected amount of compute resources, check the details on the [OVHcloud Public Cloud website](https://www.ovhcloud.com/en-ca/public-cloud/prices/).
