...
In the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl), it is possible to select the **resources** in `Step 3` of the app deployment.
