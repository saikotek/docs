...
In the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we), it is possible to select the **resources** in `Step 3` of the app deployment.
