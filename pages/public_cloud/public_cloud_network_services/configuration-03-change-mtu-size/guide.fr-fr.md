...
- Le(s) Node(s) Managed Kubernetes si vous utilisez une [passerelle personnalisée déployée dans le vRack avec un cluster Managed Kubernetes](/pages/public_cloud/containers_orchestration/managed_kubernetes/vrack-k8s-custom-gateway).
