...
- trois serveurs frontaux web de type [B2-15](https://www.ovhcloud.com/fr-ca/public-cloud/prices/){.external} ;
- deux serveurs de base de données de type [C2-30](https://www.ovhcloud.com/fr-ca/public-cloud/prices/){.external} ;
- deux disques additionnels raccordés aux serveurs de base de données ;
- l'ensemble communique via un réseau privé ;
- le scénario de *scaling* consiste à ajouter un serveur frontal web [B2-15](https://www.ovhcloud.com/fr-ca/public-cloud/prices/){.external}. »
