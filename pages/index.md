...
+ Account and service management
    ...
    + [Responsibility sharing](account-and-service-management-responsibility-sharing)
        ...
        + [Responsibility model for DevOps using Platform.sh](web_cloud/web_paas_powered_by_platform_sh/responsibility_model)
...
+ Public Cloud
    ...
    + [Public Cloud Databases](products/public-cloud-databases)
        ...
        + [Caching](products/public-cloud-databases-redis)
        ...
        + [Grafana](products/public-cloud-databases-grafana)
        ...
        + [Kafka](products/public-cloud-databases-kafka)
        ...
        + [Kafka MirrorMaker](products/public-cloud-databases-kafka-mirrormaker)
        ...
        + [M3db](products/public-cloud-databases-m3db)
        ...
        + [M3 Aggregator](products/public-cloud-databases-m3-aggregator)
        ...
        + [OpenSearch](products/public-cloud-databases-opensearch)
    ...
    + [Containers & Orchestration](products/public-cloud-containers-orchestration)
        + [Managed Kubernetes (K8s)](products/public-cloud-containers-orchestration-managed-kubernetes-k8s)
            + [Getting started](public-cloud-containers-orchestration-managed-kubernetes-k8s-getting-started)
                ...
                + [Creating a cluster through CDK for Terraform](public_cloud/containers_orchestration/managed_kubernetes/creating-a-cluster-through-cdktf)
                + [Creating a cluster with Pulumi](public_cloud/containers_orchestration/managed_kubernetes/creating-a-cluster-with-pulumi)
        ...
        + [Managed Private Registry (Harbor)](products/public-cloud-containers-orchestration-managed-private-registry)
...
+ Web Cloud
    ...
    + [Web PaaS powered by Platform.sh](products/web-cloud-web-paas-powered-by-platformsh)
        ...
        + [Administration](products/web-cloud-web-paas-powered-by-platformsh-administration)
            ...
            + [Management console](web-cloud-web-paas-powered-by-platformsh-administration-management-console)
                ...
                + [Configure environments](web_cloud/web_paas_powered_by_platform_sh/administration/configure-environment)
                + [Configure a project](web_cloud/web_paas_powered_by_platform_sh/administration/configure-project)
                + [Delete a project](web_cloud/web_paas_powered_by_platform_sh/administration/delete)
                + [Web PaaS environments](web_cloud/web_paas_powered_by_platform_sh/administration/environments)
        + [Configuration](products/web-cloud-web-paas-powered-by-platformsh-setting-up)
            + [Configuring your application](web-cloud-web-paas-powered-by-platformsh-setting-up-configuring-your-application)
                ...
                + [Access](web_cloud/web_paas_powered_by_platform_sh/configuration/access)
                + [Build and deploy](web_cloud/web_paas_powered_by_platform_sh/configuration/build)
                + [Cron jobs](web_cloud/web_paas_powered_by_platform_sh/configuration/cron)
                + [Beta Outbound firewall](web_cloud/web_paas_powered_by_platform_sh/configuration/firewall)
                + [Multiple applications](web_cloud/web_paas_powered_by_platform_sh/configuration/multi-app)
                + [Name](web_cloud/web_paas_powered_by_platform_sh/configuration/name)
                + [Relationships](web_cloud/web_paas_powered_by_platform_sh/configuration/relationships)
                + [Custom sizing](web_cloud/web_paas_powered_by_platform_sh/configuration/size)
                + [Storage](web_cloud/web_paas_powered_by_platform_sh/configuration/storage)
                + [Cron timezone](web_cloud/web_paas_powered_by_platform_sh/configuration/timezone)
                + [Type](web_cloud/web_paas_powered_by_platform_sh/configuration/type)
                + [Variables](web_cloud/web_paas_powered_by_platform_sh/configuration/variables)
                + [Web](web_cloud/web_paas_powered_by_platform_sh/configuration/web)
                + [Workers](web_cloud/web_paas_powered_by_platform_sh/configuration/workers)
            + [Configuring routes](web-cloud-web-paas-powered-by-platformsh-setting-up-configuring-routes)
                ...
                + [HTTP cache](web_cloud/web_paas_powered_by_platform_sh/configuration/cache)
                + [HTTPS](web_cloud/web_paas_powered_by_platform_sh/configuration/https)
                + [Redirects](web_cloud/web_paas_powered_by_platform_sh/configuration/redirects)
                + [Server Side Includes](web_cloud/web_paas_powered_by_platform_sh/configuration/ssi)
            + [Configuring services](web-cloud-web-paas-powered-by-platformsh-setting-up-configuring-services)
                ...
                + [Headless Chrome](web_cloud/web_paas_powered_by_platform_sh/configuration/headless-chrome)
                + [InfluxDB (Database service)](web_cloud/web_paas_powered_by_platform_sh/configuration/influxdb)
                + [Kafka (Message queue service)](web_cloud/web_paas_powered_by_platform_sh/configuration/kafka)
                + [Memcached (Object cache)](web_cloud/web_paas_powered_by_platform_sh/configuration/memcached)
                + [MariaDB/MySQL (Database service)](web_cloud/web_paas_powered_by_platform_sh/configuration/mysql)
                + [Network Storage](web_cloud/web_paas_powered_by_platform_sh/configuration/network-storage)
                + [PostgreSQL (Database service)](web_cloud/web_paas_powered_by_platform_sh/configuration/postgresql)
                + [RabbitMQ (Message queue service)](web_cloud/web_paas_powered_by_platform_sh/configuration/rabbitmq)
                + [Redis (Object cache)](web_cloud/web_paas_powered_by_platform_sh/configuration/redis)
                + [Solr (Search service)](web_cloud/web_paas_powered_by_platform_sh/configuration/solr)
                + [Varnish](web_cloud/web_paas_powered_by_platform_sh/configuration/varnish)
            + [YAML](web_cloud/web_paas_powered_by_platform_sh/configuration/configuration-yaml)
        + [Development](products/web-cloud-web-paas-powered-by-platformsh-development)
            ...
            + [(CLI) Command Line Interface](web-cloud-web-paas-powered-by-platformsh-development-command-line-interface-cli)
                ...
                + [API tokens](web_cloud/web_paas_powered_by_platform_sh/development/api-tokens)
            ...
            + [Set up your local development environment](web-cloud-web-paas-powered-by-platformsh-development-setting-up-a-local-development-environment)
                ...
                + [Tethered](web_cloud/web_paas_powered_by_platform_sh/development/tethered)
                + [Untethered local](web_cloud/web_paas_powered_by_platform_sh/development/untethered)
        ...
        + [Languages](products/web-cloud-web-paas-powered-by-platformsh-languages)
            ...
            + [Java](web-cloud-web-paas-powered-by-platformsh-languages-java)
                ...
                + [Java features frameworks](web_cloud/web_paas_powered_by_platform_sh/languages/java/frameworks)
                + [Moving a Java application to Web PaaS](web_cloud/web_paas_powered_by_platform_sh/languages/java/migration)
                + [Performance tuning Java](web_cloud/web_paas_powered_by_platform_sh/languages/java/tuning)
            ...
            + [Node.js](web-cloud-web-paas-powered-by-platformsh-languages-nodejs)
                ...
                + [Debugging](web_cloud/web_paas_powered_by_platform_sh/languages/node_js/debug)
                + [Manage Node.js versions](web_cloud/web_paas_powered_by_platform_sh/languages/node_js/node-version)
                + [Alternative Node.js install](web_cloud/web_paas_powered_by_platform_sh/languages/node_js/nvm)
            + [PHP](web-cloud-web-paas-powered-by-platformsh-languages-php)
                ...
                + [Authenticated Composer repositories](web_cloud/web_paas_powered_by_platform_sh/languages/php/composer-auth)
                + [Extensions](web_cloud/web_paas_powered_by_platform_sh/languages/php/extensions)
                + [PHP-FPM sizing](web_cloud/web_paas_powered_by_platform_sh/languages/php/fpm)
                + [Frameworks](web_cloud/web_paas_powered_by_platform_sh/languages/php/frameworks)
                + [PHP.ini settings](web_cloud/web_paas_powered_by_platform_sh/languages/php/ini)
                + [Custom Redis versions](web_cloud/web_paas_powered_by_platform_sh/languages/php/redis)
                + [Swoole](web_cloud/web_paas_powered_by_platform_sh/languages/php/swoole)
                + [Troubleshoot PHP](web_cloud/web_paas_powered_by_platform_sh/languages/php/troubleshoot)
                + [Performance tuning](web_cloud/web_paas_powered_by_platform_sh/languages/php/tuning)
                + [Using Xdebug](web_cloud/web_paas_powered_by_platform_sh/languages/php/xdebug)
        ...
        + [Frameworks](products/web-cloud-web-paas-powered-by-platformsh-frameworks)
            + [Drupal 7](web-cloud-web-paas-powered-by-platformsh-frameworks-drupal-7)
                ...
                + [Apache Solr Search](web_cloud/web_paas_powered_by_platform_sh/frameworks/apachesolr-module)
                + [Composer manager](web_cloud/web_paas_powered_by_platform_sh/frameworks/composer-manager)
                + [Customize settings.php](web_cloud/web_paas_powered_by_platform_sh/frameworks/customizing-settings-php)
                + [Developing with Drupal](web_cloud/web_paas_powered_by_platform_sh/frameworks/developing-with-drupal)
                + [Working with Drush in Drupal 7](web_cloud/web_paas_powered_by_platform_sh/frameworks/drush)
                + [Using Memcached with Drupal 7.x](web_cloud/web_paas_powered_by_platform_sh/frameworks/memcached)
                + [Migrating an existing Drupal 7 site to Web PaaS](web_cloud/web_paas_powered_by_platform_sh/frameworks/migrating)
                + [Multiple Drupal sites in a single Project](web_cloud/web_paas_powered_by_platform_sh/frameworks/multi-site)
                + [Using Redis with Drupal 7.x](web_cloud/web_paas_powered_by_platform_sh/frameworks/redis)
                + [Using Solr with the module Search API on Drupal 7.x](web_cloud/web_paas_powered_by_platform_sh/frameworks/search-api-module)
                + [SimpleSAML](web_cloud/web_paas_powered_by_platform_sh/frameworks/simplesaml)
        ...
        + [Domains](products/web-cloud-web-paas-powered-by-platformsh-domains)
            ...
            + [Custom domains](web-cloud-web-paas-powered-by-platformsh-domains-custom-domains)
                ...
                + [DNS management and Apex domains](web_cloud/web_paas_powered_by_platform_sh/domains/dns)
                + [Subdomains across different projects](web_cloud/web_paas_powered_by_platform_sh/domains/subdomains)
                + [(Optional) Configure a third-party TLS certificate](web_cloud/web_paas_powered_by_platform_sh/domains/tls)
            + [Going Live - Troubleshooting](web_cloud/web_paas_powered_by_platform_sh/domains/domains-troubleshoot)
        + [Integrations](products/web-cloud-web-paas-powered-by-platformsh-integrations)
            + [Activity scripts](web-cloud-web-paas-powered-by-platformsh-integrations-activity-scripts)
                ...
                + [Example - Discord](web_cloud/web_paas_powered_by_platform_sh/integrations/discord)
                + [HipChat](web_cloud/web_paas_powered_by_platform_sh/integrations/hipchat)
                + [Activity reference](web_cloud/web_paas_powered_by_platform_sh/integrations/reference)
                + [Example- Slack](web_cloud/web_paas_powered_by_platform_sh/integrations/slack)
                + [Utility routines](web_cloud/web_paas_powered_by_platform_sh/integrations/utility)
                + [Webhooks](web_cloud/web_paas_powered_by_platform_sh/integrations/webhooks)
            ...
            + [Profiling](web-cloud-web-paas-powered-by-platformsh-integrations-profiling)
                ...
                + [Blackfire](web_cloud/web_paas_powered_by_platform_sh/integrations/blackfire)
                + [New Relic](web_cloud/web_paas_powered_by_platform_sh/integrations/new-relic)
                + [New Relic - Java](web_cloud/web_paas_powered_by_platform_sh/integrations/java)
                + [New Relic - Node.js](web_cloud/web_paas_powered_by_platform_sh/integrations/nodejs)
                + [New Relic - PHP](web_cloud/web_paas_powered_by_platform_sh/integrations/php)
                + [Tideways](web_cloud/web_paas_powered_by_platform_sh/integrations/tideways)
            + [Source integrations](web-cloud-web-paas-powered-by-platformsh-integrations-source-integrations)
                ...
                + [Bitbucket](web_cloud/web_paas_powered_by_platform_sh/integrations/bitbucket)
                + [GitHub](web_cloud/web_paas_powered_by_platform_sh/integrations/github)
                + [GitLab](web_cloud/web_paas_powered_by_platform_sh/integrations/gitlab)
    ...
    + [Internet](products/web-cloud-internet)
        ...
        + [OverTheBox](products/web-cloud-internet-overthebox)
            ...
            + [Initial setup](web-cloud-internet-overthebox-initial-setup)
                ...
                + [Réinitialiser la configuration d'OverTheBox](web_cloud/internet/overthebox/config_reset)
...
+ Storage and Backup
    + [Object Storage](products/storage-object-storage)
        + [General information](storage-object-storage-general-information)
            ...
            + [Comparison of S3 Deployment Modes - Understanding 3-AZ / 1-AZ / Local Zones](storage_and_backup/object_storage/s3_regions_comparison)
    ...
    + [File Storage](products/storage-file-storage)
        + [Enterprise File Storage](storage-file-storage-enterprise-file-storage)
            ...
            + [Enterprise File Storage - Private network configuration - Beta](storage_and_backup/file_storage/enterprise_file_storage/netapp_network_config)
            + [File Storage services - Responsibility model](account_and_service_management/responsibility_sharing/file-storage)
