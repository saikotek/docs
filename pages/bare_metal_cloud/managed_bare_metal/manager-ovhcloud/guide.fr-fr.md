...
Pour plus de détails sur la résiliation d'un service Managed Bare Metal, consultez notre guide [Comment résilier le Managed Bare Metal](/pages/bare_metal_cloud/managed_bare_metal/how-to-cancel).
...
Vous pourrez trouver plus de détails sur cette option dans [ce guide](/pages/bare_metal_cloud/managed_bare_metal/vm_encrypt).
...
Pour plus d'informations sur cette option, vous pouvez consulter ce [guide](/pages/bare_metal_cloud/managed_bare_metal/veeam_backup_as_a_service){.external}.
