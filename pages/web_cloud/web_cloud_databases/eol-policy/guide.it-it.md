...
- I servizi Web Cloud Databases Web Hosting (noti anche come servizi SQLPPrivati), istanze SGBD dedicate raggiungibili tramite la rete Web Hosting ([vedi gli annunci](/pages/web_cloud/web_cloud_databases/clouddb-eos-eol)).
- I servizi SharedSQL Web Hosting, database MySQL raggiungibili tramite la rete Web Hosting ([vedi gli annunci](/pages/web_cloud/web_hosting/sql_eos_eol)).
