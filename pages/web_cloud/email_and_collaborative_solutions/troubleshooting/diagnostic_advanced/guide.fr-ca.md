...
- Posséder une offre **E-mail** associée à [solution d'hébergement OVHcloud](/links/web/hosting) ou une offre [Exchange](/links/web/emails-hosted-exchange).
...
- Pour une offre **E-mail**, consultez notre guide [Modifier le mot de passe d’une adresse e-mail MX Plan](/pages/web_cloud/email_and_collaborative_solutions/mx_plan/email_change_password)
