...
#### 3.1 Migrar una solución MX Plan histórica <a name="VersionHistoriqueMxplan"></a>
...
#### 3.2 Migrar la nueva versión del MX Plan <a name="NouvelleVersionMxplan"></a>
