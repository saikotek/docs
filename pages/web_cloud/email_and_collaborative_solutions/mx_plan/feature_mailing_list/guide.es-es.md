...
Para crear una lista de difusión, inicie sesión en el [área de cliente de OVHcloud](/links/manager) y, seguidamente, seleccione la pestaña `Web Cloud`{.action} en la parte superior.
