...
Il trasferimento di un dominio O2Switch richiede una procedura specifica.

**Questa guida ti mostra come trasferire un dominio O2Switch in OVHcloud**
...
- Il dominio è registrato presso il Registrar O2Switch.
