...
- You have an MX Plan solution (included in the [web hosting plan](/links/web/hosting)), an [Exchange](/links/web/emails) offer , or an external email service.
...
Below, you will find the OVHcloud MX configuration to use for our MX Plan solutions (MX Plan standalone or included in an [OVHcloud web hosting](/links/web/hosting) plan) and [Exchange](/links/web/emails). Our email servers have antispam and antivirus integrated.
