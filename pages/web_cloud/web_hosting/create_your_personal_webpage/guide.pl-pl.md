...
Aby Twoje strony WWW były widoczne dla wszystkich użytkowników, należy je umieścić na hostingu (należy aktywować hosting zgodnie [z instrukcjami zawartymi w tym przewodniku](/pages/web_cloud/web_hosting/activate_start10m)).
...
Aby umieszczać pliki na Twoim hostingu, zapoznaj się z przewodnikiem dotyczącym [korzystania z FileZilla](/pages/web_cloud/web_hosting/ftp_filezilla_user_guide).
