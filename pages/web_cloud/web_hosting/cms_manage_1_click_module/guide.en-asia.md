...
>
> If you have a [Personal Hosting](/links/web/hosting-personal-offer) offer or if you have already created all four databases of your [Pro](/links/web/hosting-professional-offer) or [Performance Hosting](/links/web/hosting-performance-offer), you will need to delete the database identified in [step 1](#step1) **BEFORE** creating a new 1-click module.
>
