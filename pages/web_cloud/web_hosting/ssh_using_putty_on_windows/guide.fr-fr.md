...
Vous pouvez éventuellement modifier le champ `Comment` avec votre propre description. Il sera affiché par les outils **PuTTY** lors de l'utilisation de la clé.
