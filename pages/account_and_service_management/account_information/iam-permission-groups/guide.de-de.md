---
title: Liste der Berechtigungsgruppen bei OVHcloud (EN)
...
To use permission groups, you will need the following:

- You have an [OVHcloud customer account](/pages/account_and_service_management/account_information/ovhcloud-account-creation)
- You know [how to set up IAM policies via the Control Panel](/pages/account_and_service_management/account_information/iam-policy-ui)
- You know [how to implement IAM policies via the API](/pages/account_and_service_management/account_information/iam-policies-api)

## Instructions

Permission groups allow you to set up turn-key access policies without having to know the full list of necessary actions.
This list will change over time as new permission groups are created.
...
<details>
<summary>Detailed policy</summary>
...
Gives full technical rights to all OVHcloud products.
This permission group resumes the rights formerly carried by the `nicTech` role.
...
Gives billing rights for all OVHcloud products.
This permission group resumes the rights formerly carried by the `nicBilling` role.
...
Gives you full technical rights on an ADSL pack.
...
Gives all billing rights on an ADSL pack.
...
Provides access to the vSphere administration console.
This permission group does not cover administration of a Private Cloud environment in the OVHcloud Control Panel.
...
Provides access to the OpenStack administration console.
This permission group does not cover the administration of a Public Cloud project in the Control Panel.
