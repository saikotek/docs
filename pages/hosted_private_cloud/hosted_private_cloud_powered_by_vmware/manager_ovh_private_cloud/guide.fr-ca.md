...
Pour plus de détails sur la résiliation d'un service Private Cloud, consultez notre guide [Comment résilier le Private Cloud](/pages/account_and_service_management/managing_billing_payments_and_services/comment_resilier_le_private_cloud).
...
Vous pourrez trouver plus de détails sur cette option dans [ce guide](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vm_encrypt).
